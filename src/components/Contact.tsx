        ...
        <section className="text-gray-600 body-font relative">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-20">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Contáctanos hoy para comenzar el viaje hacia un hogar que realmente te represente. Juntos, crearemos espacios que amarás y en los que te sentirás plenamente realizado.</p>
                </div>
                <form
                    name="contact"
                    method="POST"
